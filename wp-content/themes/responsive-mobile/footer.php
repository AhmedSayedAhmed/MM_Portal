...
<script type="text/javascript">
 document.getElementById("field_pdvqoj").readOnly = true;

jQuery(document).ready(function(){
	var trackid = Cookies.get("TrackID");
	var playing = Cookies.get("Playing");

if(!(typeof(trackid) != "undefined" && trackid !== null)) {
	Cookies.set("TrackID", "0", { expires: 7 }, { path: '/' });
 }

 if(!(typeof(playing) != "undefined" && playing !== null)) {
Cookies.set("Playing", 0, { expires: 1 }, { path: '/' });

 }



var trackid = parseInt(Cookies.get("TrackID"));
//alert(Cookies.get("Playing"));
});
</script>
